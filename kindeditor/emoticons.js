...
KindEditor.plugin('emoticons', function (K) {
    ...
    self.clickToolbar(name, function () {
        ...
        FaceHandler = {
            ...
            imageCols: { tab0: 10, tab1: 10, tab2: 10, tab3: 10, tab4: 10, tab5: 10 },
            ...
            for (; i < imgNum; ) {
                ...
                for (var j = 0; j < imgColNum; j++, i++) {
                    ...
                    if (faceImage) {
                        ...
                        textHTML.push('<img  style="background-position:left ' + (offset-1) + 'px;" title="' + infor + '" src="' + sBasePath + '0.gif" width="' + iWidth + '" height="' + iHeight + '"></img>');
                        textHTML.push('</span>');
                    } else {
